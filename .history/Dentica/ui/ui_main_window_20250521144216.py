...
class Ui_MainWindow(object):
    ...
    def apply_theme(self):
        ...
        for card in [self.TotPat_card, self.TodApp_card, self.PendPay_card, self.ComTreat_card, 
                ...
                """)
        # Apply to borders
        for borders in [self.TotPat_card, self.TodApp_card, self.PendPay_card, self.ComTreat_card,self.Pat_table_Frame,self.app_table_frame, 
                        self.bill_table_frame, self.Reports_table_frame]:
                borders.setStyleSheet(f"""
                        background: {card_bg};

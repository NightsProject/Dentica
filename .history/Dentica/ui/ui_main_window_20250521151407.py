...
class Ui_MainWindow(object):
    ...
    def apply_theme(self):
        ...
        for card in [self.TotPat_card, self.TodApp_card, self.PendPay_card, self.ComTreat_card, 
                        self.frame_2, self.frame_3, self.app_table_frame, 
        ...
        # Apply to tables
        tables = [self.UpAp_table, self.Patients_table, self.Appointments_table, self.Billing_table, self.Pat_table_Frame]
        for table in tables:

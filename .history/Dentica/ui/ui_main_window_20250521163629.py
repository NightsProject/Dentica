...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Appointments_table.setColumnWidth(0, 200)  # App. ID 
        self.Appointments_table.setColumnWidth(1, 150)  # Pat. Name
        self.Appointments_table.setColumnWidth(2, 150)  # Date
        self.Appointments_table.setColumnWidth(3, 150)  # Status
        self.Appointments_table.setColumnWidth(4, 170)  # Treatment

...
class Ui_MainWindow(object):
    ...
    def apply_theme(self, light_icon, dark_icon):
       ...
       # SIDE BUTTONS 
        ...
        for header in [self.frame,self.frame_4,self.app_frame,self.Bill_frame,self.Reports_topbar_frame, self.label_10, self.label_11]:
        ...
        for card_titles in [self.label_2, self.label_3, self.label_4, self.label_8]:
                card_titles.setStyleSheet(f"""
                        background: {card_bg};
                        color: {card_text};
                        border: none;
                        """)

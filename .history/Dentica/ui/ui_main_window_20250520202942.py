...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Appointments_table.setGeometry(QtCore.QRect(10, 60, 880, 640))
        ...
        self.Appointments_table.setColumnWidth(0, 100)
        self.Appointments_table.setColumnWidth(1, 180)
        self.Appointments_table.setColumnWidth(2, 150)
        self.Appointments_table.setColumnWidth(3, 200)
        self.Appointments_table.setColumnWidth(4, 150)
        
        self.Appointments_table.verticalHeader().setDefaultSectionSize(30)

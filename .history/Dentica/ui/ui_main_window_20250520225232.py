...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Pages.setStyleSheet("""background: red;
                                    color: black;
                                    """)
        ...
        self.theme_btn.setGeometry(QtCore.QRect(780, 23, 40, 40))  # Adjust position as needed
        theme_icon = QtGui.QIcon(f"{filepath}Theme.svg")  # You'll need a theme icon

...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Patients_table.setGeometry(QtCore.QRect(10, 20, 880, 640))
        ...
        """)
        self.Patients_table.setColumnWidth(0, 100)  # ID column
        self.Patients_table.setColumnWidth(1, 150)  # Name
        self.Patients_table.setColumnWidth(2, 120)  # Birthdate
        self.Patients_table.setColumnWidth(3, 120)  # Gender
        self.Patients_table.setColumnWidth(4, 150)  # Contact
        self.Patients_table.setColumnWidth(5, 120)  # Last Visit
        self.Patients_table.setColumnWidth(6, 120)  # Status


        self.Patients_table.verticalHeader().setDefaultSectionSize(30)

...
class Add_Patient(QtWidgets.QDialog):
    def __init__(self,parent=None):
        ...
        self.birth_date = QtWidgets.QLabel("Birth Date:", self)
        self.birth_date.setGeometry(20, 360, 80, 20)

        self.birth_input = QtWidgets.QDateEdit(self)
        self.birth_input.setGeometry(110, 360, 160, 22)
        self.birth_input.setCalendarPopup(True)
        self.birth_input.setDate(QtCore.QDate.currentDate())
                        
        self.cancel_btn = QtWidgets.QPushButton("Cancel", self)
        self.cancel_btn.setGeometry(160, 420, 80, 30)
        self.cancel_btn.clicked.connect(self.reject)
        
        self.add_patient = QtWidgets.QPushButton("Add", self)
        self.add_patient.setGeometry(80, 420, 80, 30)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Appointments_table.setColumnWidth(0, 120)  # Pat. Name
        self.Appointments_table.setColumnWidth(1, 70)  # Date
        self.Appointments_table.setColumnWidth(2, 150)  # Status
        self.Appointments_table.setColumnWidth(3, 60)  # Treatment
        self.Appointments_table.setColumnWidth(4, 100)  # Actions
